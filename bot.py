...
📋 ШАБЛОН ИДЕАЛЬНОГО ОБЪЯВЛЕНИЯ

Заголовок:
[Марка] [Модель] [Год], [пробег] км, [количество владельцев] владелец, без ДТП

Описание:

Автомобиль в идеальном состоянии! 
[Количество] владелец с [год] года.
Пробег [число] км (родной, подтвержден сервисом).
...
Все ТО вовремя, последняя замена масла — [число] км назад.
Заменены:
- [что заменено]
- [...]

Сервисная книжка на руках.
...
Цена: [цена]₽ (разумный торг возможен после осмотра)

━━━━━━━━━━━━━━━━━━━

✅ ЧЕК-ЛИСТ ПОДГОТОВКИ АВТО (50 ПУНКТОВ)
...
□ Помыть диски
□ Натереть резину
□ Убрать царапины (полировка)
□ Проверить фары (заменить лампочки)
□ Проверить поворотники
...
КОЛЕСА:
□ Проверить давление
□ Проверить износ протектора
□ Проверить диски на повреждения
□ Поменять местами (если нужно)
...
Покупатель: Здравствуйте, машина еще не продана?
Вы: Здравствуйте! Да, автомобиль еще в продаже. 
    Скажите, вы для себя рассматриваете?

Покупатель: Да, для себя
Вы: Отлично! Когда планируете покупку?

Покупатель: В ближайшее время
Вы: Прекрасно! Машина в отличном состоянии, 
...
Вы: Понимаю ваши сомнения. 
    Но цена обоснована:
    - Один владелец
    - Без ДТП
    - Все ТО вовремя
    - Второй комплект резины
    Это ниже средней по рынку!

НА ПРЕДЛОЖЕНИЕ ТОРГА:

Покупатель: 900 000₽ возьмете?
Вы: К сожалению, нет. 
    Машина в отличном состоянии, 
    цена обоснована.
    Но я могу пойти навстречу — 
    давайте встретимся посередине, 
    1 020 000₽. Это честно!

━━━━━━━━━━━━━━━━━━━

💰 КАЛЬКУЛЯТОР РЫНОЧНОЙ ЦЕНЫ

ШАГ 1: Найдите похожие авто

Откройте Auto.ru:
- Марка: [ваша]
- Модель: [ваша]
- Год: [ваш год ±1]
- Пробег: [ваш ±10 000 км]
- Регион: [ваш]

ШАГ 2: Выпишите цены

Найдите минимум 10 объявлений:
...
Оптимально: 1 190 000₽
С запасом на торг: 1 240 000₽
Для быстрой продажи: 1 140 000₽

━━━━━━━━━━━━━━━━━━━

⚠️ СПИСОК МОШЕННИЧЕСКИХ СХЕМ

СХЕМА 1: "Переведу на карту"
...
Как распознать:
- Не хотят встречаться лично
- Торопят с решением
- Обещают перевести "прямо сейчас"

Защита:
- Никогда не давайте CVV!
- Никогда не давайте код из СМС!
- Только наличные или перевод при встрече

СХЕМА 2: "Фальшивые деньги"

Что делают:
- Привозят пачку денег
- Сверху настоящие купюры
- Внутри — фальшивки или бумага

Как распознать:
- Торопят с проверкой
- Не хотят ехать в банк
- Предлагают "быстро пересчитать"

Защита:
- Проверяйте на детекторе
- Или идите в банк
- Пересчитывайте сами!

СХЕМА 3: "Друг с деньгами"

Что делают:
- Приезжает не покупатель, а "друг"
- У него "фальшивые" деньги
- Или вообще без денег

Как распознать:
- Покупатель не приходит сам
- "Друг" ведет себя подозрительно
- Торопят с оформлением

Защита:
- Общайтесь только с покупателем
- Проверяйте паспорт
...
(Скачайте готовый бланк на Auto.ru или Госуслугах)
...
5. Цена:
   - Цифрами: 1 000 000₽
   - Прописью: один миллион рублей

6. Подписи:
   - Продавец (с расшифровкой)
   - Покупатель (с расшифровкой)

Заполните в 3 экземплярах!
...
□ Пообщайтесь по телефону (оцените адекватность)
□ Договоритесь о встрече в людном месте
□ Возьмите с собой друга (безопасность)
□ Предупредите близких (куда едете)

НА ВСТРЕЧЕ:

□ Проверьте паспорт (совпадает с телефоном?)
□ Не отдавайте документы без денег
□ Проверяйте деньги (на детекторе или в банке)
□ Оформляйте договор правильно

ПОСЛЕ СДЕЛКИ:

□ Снимите авто с учета (Госуслуги)
□ Сохраните копию договора
□ Отмените страховку (вернут часть денег)
□ Сообщите в налоговую (если нужно)
...
1. НЕ ТОРОПИТЕСЬ
   - Хороший покупатель найдется
   - Не соглашайтесь на первую цену
   - Торгуйтесь правильно

2. БУДЬТЕ ЧЕСТНЫ
   - Укажите все дефекты
   - Не скрывайте проблемы
   - Честность = доверие = быстрая продажа
...
5. НЕ ВЕРЬТЕ МОШЕННИКАМ
   - Никаких предоплат
   - Никаких CVV-кодов
   - Только наличные при встрече
